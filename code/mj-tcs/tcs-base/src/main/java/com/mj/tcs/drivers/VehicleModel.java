 ...
 */
public final class VehicleModel extends Observable implements VelocityListener {

    /**
     * This class's Logger.
     */
    private static final Logger log = Logger.getLogger(VehicleModel.class.getName());
    /**
    ...
    /**
     * Updates the vehicle position on a specific path.
     * @param pathName The name of the path.
     * @param pathOffset The offset value from the source point on path.
     */
    public void setVehiclePositionOnPath(String pathName,
                                         long pathOffset) {
        if (Objects.equals(currentPathName, pathName) &&
    ...
    public void setVehicleManager(VehicleManager manager) {
        ...
        if (vehicleManager != null) {
            ...
            synchronized (vehicle) {
                vehicleManager.setAdapterState(CommunicationAdapter.State.CONNECTED);
