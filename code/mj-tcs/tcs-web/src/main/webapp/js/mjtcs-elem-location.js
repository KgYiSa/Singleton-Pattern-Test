...
function Location(x,y,type,name,textOffsetXX,textOffsetYY,two){
    x = POINT_RADIUS * 2 * (parseInt((x - boardOffsetX) / (POINT_RADIUS*2)) + 0.5);
    y = POINT_RADIUS * 2 * (parseInt((y - boardOffsetX) / (POINT_RADIUS*2)) + 0.5);
    //x = POINT_RADIUS * 2 * (x + 0.5);
    //y = POINT_RADIUS * 2 * (y + 0.5);
    var locationOrigin =  two.makeRectangle(x,y,LOCATION_DIAMETER*ZOOM,LOCATION_DIAMETER*ZOOM);
    locationOrigin.stroke = 'black';
    locationOrigin.linewidth = 1;
    this.pointOrigin = locationOrigin;


    var rect1 = two.makeRectangle(x+LOCATION_DIAMETER*ZOOM,y+LOCATION_DIAMETER*ZOOM,5,5);
    rect1.opacity = 0;
    rect1.stroke = 'black';
    rect1.linewidth = 1;
    this.rect1 = rect1;
    var rect2 = two.makeRectangle(x+LOCATION_DIAMETER*ZOOM,y-LOCATION_DIAMETER*ZOOM,5,5);
    rect2.opacity = 0;
    rect2.stroke = 'black';
    rect2.linewidth = 1;
    this.rect2 = rect2;
    var rect3 = two.makeRectangle(x-LOCATION_DIAMETER*ZOOM,y+LOCATION_DIAMETER*ZOOM,5,5);
    rect3.opacity = 0;
    rect3.stroke = 'black';
    rect3.linewidth = 1;
    this.rect3 = rect3;
    var rect4 = two.makeRectangle(x-LOCATION_DIAMETER*ZOOM,y-LOCATION_DIAMETER*ZOOM,5,5);
    rect4.opacity = 0;
    rect4.stroke = 'black';
    rect4.linewidth = 1;
    this.rect4 = rect4;
