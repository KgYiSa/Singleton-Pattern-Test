...
$(function () {
    ...
    function initTorder() {
        ...
        if (supportLocalStorage()) {
            ...
            if (vehicleList) {
                ...
                $("#create-to #torderVehicle").html("");
                $("#create-to #torderVehicle").html(dropdownItem);
            }
        }
    }
    ...
    function getDateTime() {
        var myDate = new Date();
        var myYear = myDate.getFullYear();//获取完整的年份(4位,2016)
        ...
        $("#create-to #date").val(myYear + "-" + myMonth + "-" + myDay);
        $("#create-to #time").val(myHours + ":" + myMinutes+":"+mySeconds);
    }
    ...
    $("#create-to .modal-footer .submit").on("click", function () {
        ...
        if (tbodyContent.html() != '') {
            ...
            var deadline = $("#create-to #date").val() + " " + $("#create-to #time").val();
            var intended_vehicle = $(this).attr("vehicle-uuid");
            createTransport(deadline, intended_vehicle, location_uuid, state);
    ...
    //创建调拨单的时候Vehicle下拉列表
    $("#create-to .modal-body .dropdown-menu").on("click", "a", function () {
        $("#create-to .modal-body #vehicle-dropdownMenu2").html($(this).text() + "<span class='caret'></span>");
        $("#create-to .modal-footer .submit").attr("vehicle-uuid", $(this).attr("vehicle-uuid"));
    });
