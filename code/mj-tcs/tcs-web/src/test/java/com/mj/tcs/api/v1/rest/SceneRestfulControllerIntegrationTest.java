...
public class SceneRestfulControllerIntegrationTest {
	...
	public void testGet() throws Exception {
		...
		ResponseEntity<Collection> response = restTemplate.exchange(BASE_URI
				+ "/scenes/", HttpMethod.GET, entity, Collection.class);

		Collection<SceneDto> sceneDtos = (Collection<SceneDto>) response
				.getBody();
	...
	public void post() throws IOException {
		...
		ResponseEntity<SceneDto> response = restTemplate.exchange(BASE_URI
				+ "/scenes/", HttpMethod.POST, request, SceneDto.class);
		...
		assertEquals(dto.getPathDtos().size(),
				((Collection) responseBody.get("paths")).size());
		assertEquals(dto.getPointDtos().size(),
				((Collection) responseBody.get("points")).size());
	...
	public void getOne() {
		...
		ResponseEntity<Object> response = restTemplate.exchange(BASE_URI
				+ "/scenes/" + id, HttpMethod.GET, newRequest, Object.class);
	...
	// need to instantiate resttemplate by a ClientHttpRequestFactory object to
	// support PUT
	// @Test
	...
	public void patch() { // update partial
		...
		//
		// HttpEntity<Map<String, Object>> newRequest = new
		// HttpEntity<>(requestMap);
		//
		// ResponseEntity<Object> response = restTemplate.exchange(
		// BASE_URI + "/scenes/" + id,
	...
	public static void delete() {
		...
		ResponseEntity<Object> response = restTemplate.exchange(BASE_URI
				+ "/scenes/" + id, HttpMethod.DELETE, entity, Object.class);
